...
class FlipkratScrapper:
    ...
    def getPrice(self):
        ...
        try:
            ...
            print(original_price.encode("utf-8"))
                ...
                if review_count <= expected_review:
                    ...
                    if locator.getCustomerName() in self.driver.page_source:
                        ...
                        if review_count > 0:
                            ...
                            self.clg.log('db result='+ str( db_search))
                            if db_search is not None and str(db_search) != "-1":
                                self.clg.log("Yes present" + str(len(db_search)))
                               
                                continue

                        self.clg.log("False Product " +product_name + "Not Found")
